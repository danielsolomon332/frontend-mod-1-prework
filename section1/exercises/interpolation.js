...
//Answer:
// A string will be logged in the console
// This is because we are combining an integer and a string into one statement
...
var statement = "won the game";
var quantity = 3
console.log(`The ${teamName} ${statement} by ${quantity} runs!`);
